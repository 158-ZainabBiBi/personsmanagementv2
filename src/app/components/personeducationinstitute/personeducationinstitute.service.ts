...
export class  PersoneducationinstituteService {
  ...
  get() {
    var postData = {
      ...
      request_TYPE: "GET",
      request_URI: "personeducationinstitute",
      request_BODY: ""
    }
  ...
  getAll() {
    var postData = {
      service_NAME: setting.personservice_NAME,
      request_TYPE: "GET",
      request_URI: "personeducationinstitute/all",
      request_BODY: ""
    }
    return this._HttpCallServieService_.api(postData);
  }
  ...
  getOne(id) {
    var postData = {
      service_NAME: setting.personservice_NAME,
      request_TYPE: "GET",
      request_URI: "personeducationinstitute/" + id,
      request_BODY: ""
    }
    return this._HttpCallServieService_.api(postData);
  }
  ...
  search(data) {
    var postData = {
      service_NAME: setting.personservice_NAME,
      request_TYPE: "POST",
      request_URI: "personeducationinstitute/search",
      request_BODY: JSON.stringify(data)
  ...
  searchAll(data) {
    var postData = {
      service_NAME: setting.personservice_NAME,
      request_TYPE: "POST",
      request_URI: "personeducationinstitute/search/all",
      request_BODY: JSON.stringify(data)
    }
    return this._HttpCallServieService_.api(postData);
  }
  ...
  advancedSearch(data) {
    var postData = {
      service_NAME: setting.personservice_NAME,
      request_TYPE: "POST",
      request_URI: "personeducationinstitute/advancedsearch",
      request_BODY: JSON.stringify(data)
    }
    return this._HttpCallServieService_.api(postData);
  }
  ...
  advancedSearchAll(data) {
    var postData = {
      service_NAME: setting.personservice_NAME,
      request_TYPE: "POST",
      request_URI: "personeducationinstitute/advancedsearch/all",
      request_BODY: JSON.stringify(data)
    }
    return this._HttpCallServieService_.api(postData);
  }
